(function ($) {
    ...
    /*--- column6 activation ---*/
       $('.column5').on('changed.owl.carousel initialized.owl.carousel', function (event) {
    ...
    /*--- column6 activation ---*/
       $('.column6').on('changed.owl.carousel initialized.owl.carousel', function (event) {
            $(event.target).find('.owl-item').removeClass('last').eq(event.item.index + event.page.size - 1).addClass('last')}).owlCarousel({
            autoplay: true,
            autoplayTimeout: 5*1000,
            autoplayHoverPause:true,
