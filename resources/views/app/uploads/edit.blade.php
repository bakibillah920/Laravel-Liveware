        ...
        <div class="col-lg-12">
            <div class="card shadow mt-3">
                <div class="card-header">
                    <h4 class="m-0 float-left">Update Torrent</h4>
                ...
                <div class="card-body torrent-list" id="globalModal">
                    ...
                    <form action="{{ route('uploads.update', $upload->id) }}" method="post" id="globalForm" class="form-horizontal pageLoad" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
...
{{--                                                        <option value="{{ $childCategory->id }}" {{ $$childCategory->id == $upload->category_id ? 'selected':'' }}>{{ $childCategory->name }}</option>--}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <button type="button" id="submitBtn" class="storeData form-control btn btn-success pt-2 pb-2 ml-1"><i class="zmdi zmdi-upload zmdi-hc-lg"></i> Update</button>
                            </div>
                        </div>
                    </form>
                </div>
