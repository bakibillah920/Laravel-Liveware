    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select name="parent_id" class="form-control select2" disabled>
        ...
        <div class="col-md-8">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" value="{{ $category->name }}" required="true" disabled>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="file" class="form-control" name="icon" value="{{ $category->icon }}" disabled>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                <label class="bmd-label-floating"> Serial : </label>
                <input type="number" name="serial" id="serial" class="form-control" value="{{ $category->serial }}" disabled>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                <label class="bmd-label-floating"> Status : </label>
                <select name="status" class="form-control" data-style="btn btn-link text-gray pl-0 pt-2" title="Status" disabled>
