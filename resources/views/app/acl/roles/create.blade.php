        ...
        <div class="col-lg-12">
            <div class="card shadow mt-3">
                ...
                <div class="card-body torrent-list" id="globalModal">
                    ...
                    <form action="{{ route('roles.store') }}" method="post" id="globalForm" class="form-horizontal pageLoad" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" required="true" autocomplete="nofill">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="bmd-label-floating" for="avatar"> Color : </label>
                                    <input type="color" name="color" id="color" class="form-control" required="true">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="bmd-label-floating" for="description"> Description : </label>
                                    <input type="text" name="description" id="description" class="form-control description" required="true">
                                </div>
                            </div>
                        </div>
                        <div class="row">
