        ...
        <div class="col-lg-12">
            <div class="card shadow mt-3">
                ...
                <div class="card-body torrent-list" id="globalModal">
                    ...
                    <form action="{{ route('upcoming.store') }}" method="post" id="globalForm" class="form-horizontal pageLoad" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="upload_date" id="upload_date" class="form-control" value="" required="true">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
