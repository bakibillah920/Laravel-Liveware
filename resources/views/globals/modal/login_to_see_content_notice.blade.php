<div id="loginToSeeContentNoticeModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content custom-modal">
            ...
            <div class="modal-header p-2">
                <h4 class="modal-title text-danger">Content Locked</h4>
            ...
            <div class="modal-body{{-- scroll-overlay--}}">
                <h4 class="text-center p-3">
                    To see content, please <a href="{{ route('login') }}" class="text-danger">Login</a> to your account!
                    <br>
                    <br>
